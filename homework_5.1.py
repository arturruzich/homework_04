...
filter_cars.sort(key=lambda x: x[1][4])

for car in filter_cars[:5]:
  print(car)
...
new_record = ('Name', 'Surname', 25, 'Profession', 'City')
...
print("\nAfter swapping elements at indexes 1 and 5:")
for record in people_records:
    print(record)
...
print("\nAll people at indexes 6, 10, and 13 are 30 or older:", all_above_30)
print("\nDetails for specific indexes:")
print(f"Index 6: {people_records[6]}")
print(f"Index 10: {people_records[10]}")
print(f"Index 13: {people_records[13]}")
